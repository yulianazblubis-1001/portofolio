...
### Accent Pink
Use `pink` (#FF69B4) as a secondary accent color — for playful highlights, carousel dots, hover states, or decorative elements. Pair with `pink-light` (#FFF0F5) for soft backgrounds. This adds personality and warmth alongside the primary orange.
